...
- Callers may order multiple books on one call: collect and confirm a separate email per book when needed; send one payment link per book/email pair; summarize all links before closing.
