...
const inbound_call_module_1 = require("../../delivery/inbound-call.module");
...
exports.ElevenLabsModule = ElevenLabsModule = __decorate([
    (0, common_1.Module)({
        imports: [config_1.ConfigModule, inbound_call_module_1.InboundCallModule, caller_identity_module_1.CallerIdentityModule],
