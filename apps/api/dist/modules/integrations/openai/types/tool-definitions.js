...
exports.VOICE_AGENT_TOOLS = [
    ...
    },
    {
        ...
        description: 'Normalize caller product text before catalog search (trim filler words, collapse whitespace, keep important terms). Useful for noisy voice transcripts.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    {
        name: 'detectLanguage',
        description: 'Estimate caller language code from text snippet for voice adaptation. Returns best-effort result only; never invent locale-specific product facts.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    {
        name: 'validateEmail',
        description: 'Validate and normalize customer email before checkout or payment-link delivery.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Load one Shopify-backed product with variants and inventory. Call after searchProducts or when the caller names a specific item. Quote ONLY fields present in the JSON—never guess price or stock.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Get authoritative product/variant availability and price from synced Shopify catalog cache.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Create a Shopify draft-order invoice style checkout link using customer and confirmed items.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Create a secure Shopify payment link in storefront cart or draft-order invoice mode.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Create a secure Shopify checkout URL AFTER the caller confirmed their email aloud. Line items MUST use variant/product ids from prior tool results. Never collect card numbers, CVV, or expiry on the phone. Omit mode to use the agent default checkout mode.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
                ...
                forceNewCheckout: {
                    type: 'boolean',
                    description: 'Set true only when the caller explicitly wants a new checkout link despite identical cart (default: reuse open checkout for this call).',
                },
            },
    ...
    },
    {
        ...
        description: 'Email the checkout link produced by createCheckoutLink. NEVER tell the caller the email was sent until this tool returns ok:true.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Queue human follow-up (callback / team alert). Use when the caller insists on a person, shows strong frustration, policy exception, or repeated tool failure. Include a concise reason string.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    {
        name: 'search_books',
        description: 'LEGACY alias for catalog search—same Shopify backing as searchProducts. Prefer searchProducts when both are enabled.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Shopify order lookup after collecting order number AND verification phone (last-mile fraud safety). Never fabricate tracking.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'Generate/send checkout for an ORDER BOOKING draft that is READY_FOR_PAYMENT. Still never collect raw card data on the phone.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
    ...
    },
    {
        ...
        description: 'RAG retrieval across uploaded FAQs, policies, and store docs. Use retrieved snippets only—never invent policy text.',
        parameters: {
            type: 'object',
            additionalProperties: false,
            properties: {
...
exports.ALL_TOOL_NAMES = exports.VOICE_AGENT_TOOLS.map((t) => t.name);
