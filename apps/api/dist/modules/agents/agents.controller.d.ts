...
export declare class AgentsController {
    ...
    create(tenantId: string, userId: string, dto: CreateAgentDto): Promise<{
        ...
        toolPermissions: import("@prisma/client/runtime/library").JsonValue;
