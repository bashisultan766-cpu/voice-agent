...
export declare class AgentsController {
    ...
    syncSecretsFromSettings(tenantId: string, userId: string, id: string): Promise<{
        updatedSecrets: Record<"twilioAccountSid" | "shopifyAdminToken" | "openaiApiKey" | "elevenlabsApiKey" | "twilioAuthToken" | "resendApiKey" | "databaseUrl" | "databaseAccessToken" | "shopifyApiKey" | "shopifyApiSecret" | "webhookSecret", boolean>;
        shopifyStoreUrl: string | null;
        voiceId: string | null;
        status: import("@prisma/client").$Enums.AgentStatus;
        id: string;
