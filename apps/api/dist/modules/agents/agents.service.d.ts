...
export declare class AgentsService {
    ...
    update(tenantId: string, id: string, dto: UpdateAgentDto, actorUserId?: string): Promise<{
        updatedSecrets: Record<"twilioAccountSid" | "shopifyAdminToken" | "shopifyApiKey" | "shopifyApiSecret" | "webhookSecret" | "databaseUrl" | "databaseAccessToken" | "twilioAuthToken" | "openaiApiKey" | "elevenlabsApiKey", boolean>;
        id: string;
        tenantId: string;
        clientId: string | null;
        storeId: string | null;
