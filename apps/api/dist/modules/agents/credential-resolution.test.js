...
(0, node_test_1.default)('uses agent credential before workspace and env', () => {
    const resolved = (0, credential_priority_util_1.resolveCredentialPriority)('agent-key', 'workspace-key', 'env-key');
...
(0, node_test_1.default)('uses workspace credential when agent value missing', () => {
    const resolved = (0, credential_priority_util_1.resolveCredentialPriority)('', 'workspace-key', 'env-key');
...
(0, node_test_1.default)('uses env credential when agent/workspace missing', () => {
    const resolved = (0, credential_priority_util_1.resolveCredentialPriority)(undefined, '', 'env-key');
...
(0, node_test_1.default)('returns missing source when no credential found', () => {
    const resolved = (0, credential_priority_util_1.resolveCredentialPriority)('', undefined, '  ');
