...
import { runLlmAgentTurn } from "../adapters/openaiAdapter.js";
...
function shouldYieldFiller(userMessage: string): boolean {
  return /\b\d{4,}\b/.test(userMessage) || /\b(isbn|978|979)\b/i.test(userMessage);
}
