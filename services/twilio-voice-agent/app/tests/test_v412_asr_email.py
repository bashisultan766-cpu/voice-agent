...
class TestPrefixArtifact:
    def test_no_artifact_all_lowercase_spelling(self):
        from app.pipeline.email_capture import _has_prefix_artifact
    ...
    def test_uppercase_artifact_lowers_confidence(self):
        from app.pipeline.email_capture import normalize_spoken_email, email_confidence
...
class TestDomainSuffixOnly:
    def test_dot_com(self):
        from app.pipeline.email_capture import is_domain_suffix_only
...
class TestFragmentAssembler:
    def test_assemble_local_and_dotcom(self):
        from app.pipeline.email_capture import assemble_email_from_fragments
